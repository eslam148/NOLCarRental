        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeeklyPrice = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExtraTypePrices", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BrandEn = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ModelAr = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ModelEn = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExtraTypePriceId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingExtras_ExtraTypePrices_ExtraTypePriceId",
                        column: x => x.ExtraTypePriceId,
                        principalTable: "ExtraTypePrices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingExtras_ExtraTypePriceId",
                table: "BookingExtras",
                column: "ExtraTypePriceId");
